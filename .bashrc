...
# This is Saul's bashrc, most of it is from Chris Titus
# MY CHANGES
# - Added some binaries to PATH
# - alias for ddcutil
# - alias for editing specific personal files
# - alias for quick commit with a message
# - alias for quick commit with a message
...
# Quick commit with commit message
gcomm() {
